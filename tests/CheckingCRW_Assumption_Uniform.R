...
dat <- read.csv((file = here::here('tests', 'data', 'CRW_output_uniform.csv')))
...
## so yes, sin is close to 0 therefore we can use formula 5.2 (p139)
...
pdf('./tests/plots/UnifImplement_Comparison_obs_exp_NetSqDispl.pdf')
